...
services:
  ...
  backup:
    ...
    environment:
      ...
      PGDUMP_RATE_LIMIT: 1024    # optional, KB/s
      S3_REGION: region
...
- The container runs a backup immediately and then exits.
- If `PASSPHRASE` is provided, the backup will be encrypted using GPG.
- If `PGDUMP_RATE_LIMIT` is provided, pg_dump output will be rate limited to the specified KB/s.
